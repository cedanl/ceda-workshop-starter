# PLANNING — CEDA Workshop

| ID | Titel | Type | Status | Deps | Skill | Output |
|----|-------|------|--------|------|-------|--------|
| S1 | Strategy | taak | done | — | — | Doel: CEDA presenteren als kenniscentrum voor data-analyse in het onderwijs. Doelgroep: data-analisten en beleidsmakers bij HO/MBO-instellingen. |
...
| S6 | Launch/Deploy | taak | done | S5 | — | GitHub Pages live: https://cedanl.github.io/ceda-workshop-starter/ — PR: https://github.com/cedanl/ceda-workshop-starter/pull/2 |
